      ...
      <div className="paying-attention-frontend" style={{backgroundColor: props.bgColor, textAlign: props.theAlignment}}>
        ...
        <ul>
          {props.answers.map(function(answer, index) {
            return (
              <li className={(isCorrectDelayed && index == props.correctAnswer ? "no-click" : "") + (isCorrectDelayed && index != props.correctAnswer ? "fade-incorrect" : "")} onClick={isCorrect ? undefined : () => handleAnswer(index)}>
